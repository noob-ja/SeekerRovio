...
The Rovio mobile webcam is controlled through a web-based API.  The RovioApi
class wraps http calls to a Rovio and returns the appropriate responses.  It
also provides some additional support methods for parsing the responses.

Classes:
  - RovioApi: Access to an instance of a Rovio mobile webcam
